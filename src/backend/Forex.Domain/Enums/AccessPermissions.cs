...
/// Bit qiymatlari frontend (Forex.ClientService.Enums.AccessPermissions) bilan
/// AYNAN bir xil bo'lishi shart — mask xom `long` bo'lib tarmoqdan o'tadi.
/// </summary>
[Flags]
public enum AccessPermissions : long
{
    ...
    Payments = 1 << 2,   // 4   — To'lov (Transaction)
